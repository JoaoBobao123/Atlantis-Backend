...
new Book { Id = 3, Title = "Grande Sertão: Veredas 🏜️⚔️", Author = "João Guimarães Rosa", Year = 1956, Quantity = 4 },
...
new Book { Id = 6, Title = "Macunaíma 🌀🤹‍♂️", Author = "Mário de Andrade", Year = 1928, Quantity = 11 },
new Book { Id = 7, Title = "Capitães da Areia 🏖️👶", Author = "Jorge Amado", Year = 1937, Quantity = 2 },
new Book { Id = 8, Title = "Vidas Secas 🌵🐕", Author = "Graciliano Ramos", Year = 1938, Quantity = 9 },
new Book { Id = 9, Title = "A Moreninha ❤️⛵", Author = "Joaquim Manuel de Macedo", Year = 1844, Quantity = 2 },
new Book { Id = 10, Title = "O Tempo e o Vento 🌪️🏡", Author = "Erico Verissimo", Year = 1949, Quantity = 1 },
...
new Book { Id = 15, Title = "Fogo Morto 🔥⚰️", Author = "José Lins do Rego", Year = 1943, Quantity = 1 },
};
